...
//             {/* <li className='cursor-pointer flex items-center gap-1' onClick={() => setToggleSideBar(false)}><FaArrowAltCircleLeft className='w-5 h-5 text-green-500' /> Back</li> */}
//             <li className='cursor-pointer flex items-center gap-1' onClick={handleBack}><FaArrowAltCircleLeft className='w-5 h-5 text-green-500' /> Back</li>

//             <li className='cursor-pointer flex items-center gap-1'>
//               <IoMdArrowDropdown className='w-5 h-5' />
//               <FaArrowAltCircleRight className='w-5 h-5 text-gray-500' />
